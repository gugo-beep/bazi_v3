...
const shenshaRules = [
    ...
    },
    {
        ...
        preconditions: [],
        rules: [
          { trigger:{ on:'monthZhi', value:['寅','卯','辰']}, judgment:{ on:'dayPillar', value:'乙卯'}},
          { trigger:{ on:'monthZhi', value:['巳','午','未']}, judgment:{ on:'dayPillar', value:'丙午'}},
          { trigger:{ on:'monthZhi', value:['申','酉','戌']}, judgment:{ on:'dayPillar', value:'辛酉'}},
          { trigger:{ on:'monthZhi', value:['亥','子','丑']}, judgment:{ on:'dayPillar', value:'壬子'}}
      ]
    },
    {
        name: '地转煞',
